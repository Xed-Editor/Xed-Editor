...
async function sendMessageAndExit() {
  try {
    ...
    await bot.sendMessage(chatId, "⭐ <a href=\"https://github.com/" + actor + "\">@" + actor + "</a> Starred <a href=\"https://github.com/RohitKushvaha01/Xed-Editor\">Xed-Editor</a>", { parse_mode: "HTML" });
    // Exit the script
    process.exit();
  } catch (error) {
