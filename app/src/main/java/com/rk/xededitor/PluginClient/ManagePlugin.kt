  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    binding.fab.setOnClickListener {
      ...
      ActionPopup(this).apply {
        ...
        addItem(
          "Zip Install",
          "Install Plugin from local storage",
          ContextCompat.getDrawable(this@ManagePlugin, com.rk.libcommons.R.drawable.archive),
          View.generateViewId()
        ) {
          hide()
        ...
        addItem(
          ...
          ContextCompat.getDrawable(this@ManagePlugin, R.drawable.download),
          View.generateViewId()
        ) {
          hide()
      ...
      data?.data?.let { uri ->
        ...
        lifecycleScope.launch(Dispatchers.IO) {
          val isInstalled = contentResolver.openInputStream(uri)
            ?.let { PluginInstaller.installFromZip(this@ManagePlugin, it) } ?: false
