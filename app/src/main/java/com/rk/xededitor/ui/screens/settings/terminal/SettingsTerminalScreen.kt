...
fun SettingsTerminalScreen() {
  PreferenceLayout(
    ...
    PreferenceCategory(label = stringResource(id = R.string.fail_safe),
      ...
      endWidget = {
        Switch(
          modifier = Modifier
            .padding(12.dp)
            .height(24.dp), checked = failSafe, onCheckedChange = null
        )
      })
    ...
    PreferenceCategory(label = "Show Virtual Keyboard",
      description = "Show virtual keyboard when Physical keyboard is connected",
      iconResource = R.drawable.edit,
      onNavigate = {
        showVirtualKeyboard = !showVirtualKeyboard
        PreferencesData.setBoolean(PreferencesKeys.SHOW_VIRTUAL_KEYBOARD, showVirtualKeyboard)
      },
      endWidget = {
        Switch(
          modifier = Modifier
            .padding(12.dp)
            .height(24.dp), checked = showVirtualKeyboard, onCheckedChange = null
        )
      })
    ...
    if (showLShellDialog) {
      var inputValue by remember {
        mutableStateOf(
          PreferencesData.getString(PreferencesKeys.SHELL, "/bin/sh").removePrefix(File(context.filesDir.parentFile, "rootfs/").absolutePath)
        )
      }
      InputDialog(title = stringResource(id = R.string.Lshell), inputLabel = "eg. /bin/sh", inputValue = inputValue, onInputValueChange = {
        inputValue = it
      }, onConfirm = {
    ...
    if (showTextSizeDialog) {
      ...
      InputDialog(title = stringResource(id = R.string.text_size),
    ...
    PreferenceCategory(label = stringResource(id = R.string.useCtrlWorkaround),
      ...
      endWidget = {
        Switch(
          modifier = Modifier
            .padding(12.dp)
            .height(24.dp), checked = ctrlWorkAround, onCheckedChange = null
        )
      })
    ...
    PreferenceCategory(label = stringResource(id = R.string.force_char),
      ...
      endWidget = {
        Switch(
          modifier = Modifier
            .padding(12.dp)
            .height(24.dp), checked = forceChar, onCheckedChange = null
        )
      })
    ...
    PreferenceCategory(label = stringResource(id = R.string.sim_hard_links),
      ...
      endWidget = {
        Switch(
          modifier = Modifier
            .padding(12.dp)
            .height(24.dp), checked = link2sym, onCheckedChange = null
        )
      })
    
    PreferenceCategory(label = stringResource(id = R.string.sim_ashmem),
      ...
      endWidget = {
        Switch(
          modifier = Modifier
            .padding(12.dp)
            .height(24.dp), checked = ashememFd, onCheckedChange = null
        )
      })
    
    PreferenceCategory(label = stringResource(id = R.string.sysvipc),
      ...
      endWidget = {
        Switch(
          modifier = Modifier
            .padding(12.dp)
            .height(24.dp), checked = sysvipc, onCheckedChange = null
        )
      })
    ...
    PreferenceCategory(label = stringResource(id = R.string.kill_on_exit),
      ...
      endWidget = {
        Switch(
          modifier = Modifier
            .padding(12.dp)
            .height(24.dp), checked = killOnExit, onCheckedChange = null
        )
      })
  }
}