...
/**
 * A pool of [Span] objects. Subclasses of [Span]s can use this pool to recycle and reuse [Span]
...
constructor(
    ...
    companion object {
        ...
        /**
         * Small capacity (8192 objects). This should be used for spans that will not be used too
         * frequently (for example, [StaticColorSpan]).
         */
        const val CAPACITY_SMALL = 8192

        /**
         * Small capacity ([CAPACITY_SMALL] * 2 objects). This should be used for spans that will be
         * used frequently (for example, [Span]).
         */
    ...
    /**
     * Return the given span to the pool. This method should not be called directly. Instead, call
     * [Span.recycle] and it should automatically return itself to the pool.
     *
