 ...
 *
 * (e.g. viewing method signatures), consider to remove them or abstract additional classes for the
 * caller to provide support
 */
abstract class RequestManager :
    LanguageClient, TextDocumentService, WorkspaceService, LanguageServer {
    // ------------------------------------- Server2Client
    // ---------------------------------------------------------//
    abstract override fun showMessage(messageParams: MessageParams)

    abstract override fun showMessageRequest(
    ...
    abstract override fun unregisterCapability(
        params: UnregistrationParams
    ): CompletableFuture<Void>

    abstract override fun applyEdit(
    ...
    abstract override fun willSaveWaitUntil(
    ...
    abstract override fun completion(
        params: CompletionParams
    ): CompletableFuture<Either<List<CompletionItem>, CompletionList>>?

    abstract override fun resolveCompletionItem(
    ...
    @Deprecated("")
    abstract fun signatureHelp(
        params: TextDocumentPositionParams
    ): CompletableFuture<SignatureHelp>?

    abstract override fun signatureHelp(
    ...
    @Deprecated("")
    abstract fun documentHighlight(
        params: TextDocumentPositionParams
    ): CompletableFuture<List<DocumentHighlight>>?

    abstract override fun documentHighlight(
        params: DocumentHighlightParams
    ): CompletableFuture<List<DocumentHighlight>>?

    abstract override fun documentSymbol(
        params: DocumentSymbolParams
    ): CompletableFuture<List<Either<SymbolInformation, DocumentSymbol>>>?

    abstract override fun formatting(
        params: DocumentFormattingParams
    ): CompletableFuture<List<TextEdit>>?

    abstract override fun rangeFormatting(
        params: DocumentRangeFormattingParams
    ): CompletableFuture<List<TextEdit>>?

    abstract override fun onTypeFormatting(
        params: DocumentOnTypeFormattingParams
    ): CompletableFuture<List<TextEdit>>?

    @Deprecated("")
    abstract fun definition(
        params: TextDocumentPositionParams
    ): CompletableFuture<Either<List<Location>, List<LocationLink>>>?

    abstract override fun definition(
        params: DefinitionParams
    ): CompletableFuture<Either<List<Location>, List<LocationLink>>>?

    abstract override fun codeAction(
    ...
    abstract override fun documentLink(
        params: DocumentLinkParams
    ): CompletableFuture<List<DocumentLink>>?

    abstract override fun documentLinkResolve(
        unresolved: DocumentLink
    ): CompletableFuture<DocumentLink>?

    abstract override fun rename(params: RenameParams): CompletableFuture<WorkspaceEdit>?

    abstract override fun implementation(
        params: ImplementationParams
    ): CompletableFuture<Either<List<Location>, List<LocationLink>>>?

    abstract override fun typeDefinition(
        params: TypeDefinitionParams
    ): CompletableFuture<Either<List<Location>, List<LocationLink>>>?

    abstract override fun documentColor(
        params: DocumentColorParams
    ): CompletableFuture<List<ColorInformation>>?

    abstract override fun colorPresentation(
        params: ColorPresentationParams
    ): CompletableFuture<List<ColorPresentation>>?

    abstract override fun foldingRange(
