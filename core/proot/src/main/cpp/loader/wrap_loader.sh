...
/home/rohit/Android/Sdk/ndk/28.0.13004108/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-objcopy --input-target=binary --output-target=$OUTPUT_TARGET --binary-architecture $ARCH loader.exe loader-wrapped.o
