...
object RendererUtils {
    ...
    fun getBackgroundColor(span: Span, colorScheme: EditorColorScheme): Int {
        ...
        val color =
            resolver.getBackgroundColor(span) ?: return colorScheme.getColor(span.backgroundColorId)
    ...
    fun getForegroundColor(span: Span, colorScheme: EditorColorScheme): Int {
        ...
        val color =
            resolver.getForegroundColor(span) ?: return colorScheme.getColor(span.foregroundColorId)
