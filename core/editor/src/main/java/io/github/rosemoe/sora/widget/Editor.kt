 ...
 */
inline fun <reified T : Event> CodeEditor.subscribeAlways(
 ...
 */
inline fun <reified T : Event> CodeEditor.subscribeEvent(
...
/**
 * Replace the built-in component to the given one. The new component's enabled state will extend
 * the old one.
 *
