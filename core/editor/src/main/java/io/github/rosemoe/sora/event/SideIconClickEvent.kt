...
/**
 * Called when side icon is clicked. If you would like to avoid [ClickEvent] to be triggered, you
 * are expected to intercept editor by calling [SideIconClickEvent.intercept]
 */
