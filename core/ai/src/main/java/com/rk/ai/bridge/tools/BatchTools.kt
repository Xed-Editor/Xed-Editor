...
class ApplyBatchEditsTool : BaseMcpTool() {
    ...
    override fun getDescription(): String = "RECOMMENDED: Applies multiple file changes at once. Takes a JSON object where keys are absolute file paths and values are new content."
